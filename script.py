...
def error():
    ...
    """
    print(
        f"Usage: {sys.argv[0]} <rip> <bsa> <output>\n\nWhere:",
...
if rip < bsa:
    print(
        "Your return address ({})".format(sys.argv[1]),
        "is above your buffer address ({}).".format(sys.argv[2]),
...
print("Wrote {} bytes to {}".format(n, sys.argv[3]))
output.close()
